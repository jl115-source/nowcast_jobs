...
export function SidebarNavigation({ currentPage, onPageChange }: SidebarNavigationProps) {
  ...
  const [isJobDropdownOpen, setIsJobDropdownOpen] = useState(true)
  const [isResourcesDropdownOpen, setIsResourcesDropdownOpen] = useState(true)
  ...
  const resourcePages = [
    { id: "resources", label: "Certification", icon: BookOpen },
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="p-4 border-b border-sidebar-border flex items-center justify-between">
            ...
            <Button
              ...
              className="text-sidebar-foreground hover:!bg-transparent hidden md:flex"
            >
